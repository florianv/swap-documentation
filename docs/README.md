# Currency exchange rates for PHP

## About

Swap is a PHP framework to retrieve latest and historical currency exchange rates from various services such as 
**[Fixer](https://fixer.io)**, **[currencylayer](https://currencylayer.com)** or **[1Forge](https://1forge.com)**.

It also provides an easy integration with [Laravel via a package](/laravel/) and [Symfony with its bundle](/symfony/).
